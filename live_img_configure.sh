...
echo "deb http://deb.debian.org/debian/ stretch main contrib" > /etc/apt/sources.list.d/base.list
...
#  git gdebi-core python3-dev python3-setuptools python3-cffi cryptsetup debootstrap
